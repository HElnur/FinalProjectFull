...
namespace Devita.Services
{
    public class LayoutService : Controller
    {
        ...
        public LayoutService(DevitaContext context , UserManager<AppUser> userManager , IHttpContextAccessor httpContext)
        {
            _context = context;
        ...
        private BasketViewModel _getBasketItems(List<CookieBasketItemViewModel> cookieBasketItems)
        {
            ...
            foreach (var item in cookieBasketItems)
            {
                ...
                basket.TotalAmount += basketItem.Count * basketItem.Price;
